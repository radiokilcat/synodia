...
void EditorBar::addGameObject(GameObject* obj) {
    objects.push_back(obj);
}

void EditorBar::setRootNode(std::shared_ptr<GameObject> node) {
    scene = node;
}

void EditorBar::drawPropertiesWidget(std::shared_ptr<GameObject> node) {
...
void EditorBar::drawSingleNode(std::shared_ptr<GameObject> node) {
...
void EditorBar::drawNode(std::weak_ptr<GameObject> node) {
